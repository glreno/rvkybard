...
<%
    ...
    kb.startRow();
    kb.spacer(1);
    kb.key("F","KB_F",6,6,null,null,"",D2+"key.svgt","S1=Forward","S2=View");
    ...
    kb.key("G","KB_G",6,6,null,null,"",D2+"key.svgt","S1=Galactic","S2=Chart");
    ...
    kb.key("S","KB_S",6,6,null,null,"",D2+"key.svgt","S1=Shields","S2=");
    ...
    kb.key(" ","KB_SPACE",6,6,null,null,"",null);
