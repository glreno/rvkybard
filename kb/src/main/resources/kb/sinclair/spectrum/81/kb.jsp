...
<%
    ...
    kb.key("RED","2",5,5,null,null,"",KC,"FS=10","TXTC="+REDC,"BGC=none");
    kb.key("MAGENTA","3",5,5,null,null,"",KC,"FS=10","TXTC=#F0F","BGC=none");
    kb.key("GREEN","4",5,5,null,null,"",KC,"FS=10","TXTC="+GREENC,"BGC=none");
    ...
    kb.key("9","9",5,5,null,null,"",KN,"FS=24","FSs=12","Ss=)","Sf=GRAPHICS","Se=CAT","OffsetXs=5");
    kb.key("0","0",5,5,null,null,"",KN,"FS=24","FSs=12","Ss=_","Sf=DELETE","Se=FORMAT");
    ...
    kb.startRow();
    kb.spacer(2+2);
    kb.key("Q","Q",5,5,null,null,"",KK,"Ss=<=","Sk=PLOT","Sf=SIN","Se=ASN","FSs=24","OffsetYs=6");
    kb.key("W","W",5,5,null,null,"",KK,"Ss=<>","Sk=DRAW","Sf=COS","Se=ACS");
    kb.key("E","E",5,5,null,null,"",KK,"Ss=>=","Sk=REM","Sf=TAN","Se=ATN");
    kb.key("R","R",5,5,null,null,"",KK,"Ss=<","Sk=RUN","Sf=INT","Se=VERIFY");
    kb.key("T","T",5,5,null,null,"",KK,"Ss=>","Sk=RAND","Sf=RND","Se=MERGE");
    ...
    kb.key("O","O",5,5,null,null,"",KK,"Ss=;","Sk=POKE","Sf=PEEK","Se=OUT");
    kb.key("P","P",5,5,null,null,"",KK,"Ss=\"","Sk=PRINT","Sf=TAB","Se=&copy;");
    kb.endRowThirds(5);

    // asdfghjkl newline
    kb.startRow();
    kb.spacer(2+3);
    kb.key("A","A",5,5,null,null,"",KK,"Ss=STOP","Sk=NEW","Sf=READ","Se=~");
    ...
    kb.key("H","H",5,5,null,null,"",KKi,"Sk=GOSUB","Sf=SQR","FSs=16","Se=CIRCLE","SX=0","SY=0","ARROWLENGTH=10","ARROWWIDTH=10","ARROWCOLOR="+REDC,"ARROW=180","INC1="+DART+"arrow2.svgt");
    kb.key("J","J",5,5,null,null,"",KK,"Ss=-","FSs=20","Sk=LOAD","Sf=VAL","Se=VAL$");
    kb.key("K","K",5,5,null,null,"",KK,"Ss=+","FSs=20","Sk=LIST","Sf=LEN","Se=SCREEN$");
    kb.key("L","L",5,5,null,null,"",KK,"Ss==","Sk=LET","Sf=USR","FSs=16","Se=ATTR");
    ...
    kb.key("X","X",5,5,null,null,"",KK,"Ss=&pound;","Sk=CLEAR","Sf=EXP","FSs=20","Sk=CLEAR","Se=INK");
    ...
    kb.key("B","B",5,5,null,null,"",KK,"Ss=*","Sk=BORDER","Sf=BIN","FSs=16","Se=BRIGHT");
    kb.key("N","N",5,5,null,null,"",KK,"Ss=,","Sk=NEXT","Sf=INKEY$","FSs=16","Se=OVER");
    kb.key("M","M",5,5,null,null,"",KK,"Ss=.","Sk=PAUSE","Sf=PI","FSs=16","Se=INVERSE");
